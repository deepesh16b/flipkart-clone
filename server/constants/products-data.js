export const productsData = [
  ...
  },
  {
    ...
    title: {
      ...
      longTitle:
        "Steelbird SBA-7 7Wings ISI Certified Flip-Up Helmet for Men and Women Motorbike Helmet  (Dashing Black with Outer Clear and Inner Smoke Sun Shield)",
    },
    price: {
      mrp: 1849,
      cost: 1479,
    ...
    quantity: 1,
    description:
      "LHelmet Fitted with Clear Visor Quick release chinstrap mechanism for ease of operation and safety ,High quality UV resistant Polyurethane paints used for aesthetic enhancement ,Dynamic ventilation system for increased air flow providing more comfort to the rider while driving ,Outer shell injected from special high impact grade of engineering thermoplastic ,Regulated density EPS concussion padding lined with specially treated anti allergic velveteen",
    discount: "From 699",
    tagline: "Vega, Steelbird & more",
  },
  {
    id: "product10",
    ...
    quantity: 1,
    description:
      "APPLE iPhone 14 Pro (Deep Purple, 128 GB),128 GB ROM 15.49 cm (6.1 inch) Super Retina XDR Display 48MP + 12MP + 12MP | 12MP Front Camera A16 Bionic Chip, 6 Core Processor Processor.",
  ...
  {
    id: "product12",
    url: "https://rukminim1.flixcart.com/image/832/832/xif0q/t-shirt/x/v/e/l-all-rbcropn-sky-one-nb-nicky-boy-original-imagkq6hgg5gqsep.jpeg?q=70",
    detailUrl:
      "https://rukminim1.flixcart.com/image/832/832/xif0q/t-shirt/x/v/e/l-all-rbcropn-sky-one-nb-nicky-boy-original-imagkq6hgg5gqsep.jpeg?q=70",
    title: {
      shortTitle: "Men T-Shirt",
      longTitle: "Men Printed Round Neck Light Blue T-Shirt ",
    },
    price: {
      mrp: 666,
      cost: 249,
    ...
    quantity: 1,
    description: "NB NICKY BOY Men Printed Round Neck Light Blue T-Shirt",
    discount: "Upto 70% Off",
    tagline: "Buy Now!",
  },
  {
    ...
    quantity: 1,
    description:
      "Get a smartphone for yourself that can detect your moods and react appropriately. The Samsung Galaxy Ultra's potent processor and advanced camera sensor can handle low light and noise reduction. The phone's Snapdragon 8 Gen 2 processor, which also provides a long battery life to carry you through even the busiest days, also enables quick gaming and video streaming. You can also launch Expert RAW to take high-resolution RAW photos that are vivid and packed with information. Moreover, Dynamic AMOLED 2X offers clear, brilliant details in both bright and low-light conditions.",
    discount: "Extra 10% Off",
    tagline: "Grab Now!",
  },
];
